...
- Homepage URL：你的 `MAMA_LINK_URL`
- Authorization callback URL：`<MAMA_LINK_URL>/oauth/callback`
...
```bash
export MAMA_GITHUB_OAUTH_SCOPES="repo read:user user:email read:org gist workflow"
```
